...
const NFT = () => {
    ...
    const {data:forSaleItem } = useMoralisQuery("PlacedListings", query => query.
    ...
    const handleUpdateListing = async () =>{
        ...
        const options = {
            ...
            functionName: "setListing",
            params: {
                price: Moralis.Units.ETH(updatePrice), 
                NFTCollectionAddress:collectionAddress,
                tokenId: tokenId
            }    
        }
    ...
    if (metadata && owner && collection.length ){
        return (
            <>
                ...
                { isForSale(tokenId) && isOwnerCurrentAddress() &&
                    <>
                        ...
                        <div>
                            <Input
                            autoFocus
                            placeholder="Update Price in Matic"
                ...
                <NFTHistory collectionAddress={collectionAddress} tokenId={tokenId} />
            </>
        )
    } else{
        return null
