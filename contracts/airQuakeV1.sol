...
contract ERC721Token is ERC721 {
  ...
  */
  function transfer(address _to, uint256 _tokenId) override virtual public onlyOwnerOf(_tokenId) {
  ...
  */
  function approve(address _to, uint256 _tokenId) override virtual public onlyOwnerOf(_tokenId) {
...
contract AirQuake is ERC721Token, Ownable, ERC721Metadata {
    using SafeMath for uint256;
